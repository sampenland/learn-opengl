...
int main()
{
    ...
    Shaders objectShader = Shaders("src/shaders/vertex/object.glsl",
        "src/shaders/fragment/object.glsl");

    Shaders lightShader = Shaders("src/shaders/vertex/light.glsl",
        "src/shaders/fragment/light.glsl");
